...
export default function NotificationsPage() {
  ...
  const notifications = [
    {
      ...
      threadPreview: "Just launched my new website! Check it out...",
      timestamp: "2m ago",
      read: false,
    },
    {
      ...
      threadPreview: "That's awesome! I'll check it out.",
      timestamp: "1h ago",
      read: false,
    },
    {
      ...
      threadPreview: "Hey @alexj, what do you think about this?",
      timestamp: "3h ago",
      read: true,
    },
    {
  ...
  const mentionsNotifications = notifications.filter(
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="side-navigation">
        ...
        <Link href="/notifications" className="nav-icon-active">
          <Heart size={28} />
        </Link>
          ...
          <DropdownMenuContent className="page-menu">
            {pages.map((page) => (
              <DropdownMenuItem key={page.path} asChild>
                <Link 
                  href={page.path} 
                  className={page.name === "Notifications" ? "page-menu-item-active" : "page-menu-item"}
                >
                  {page.name}
                  {page.name === "Notifications" && <Check className="ml-auto" size={18} />}
                </Link>
              </DropdownMenuItem>
            ))}
            ...
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="all" className="space-y-0">
                {allNotifications.map((notification) => (
                  <div
                    key={notification.id}
                    className={`post-divider py-4 last:border-0 ${
              ...
              <TabsContent value="mentions" className="space-y-0">
                {mentionsNotifications.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-muted-foreground">
                      No mentions yet. When someone mentions you, you'll see it
                      here.
                    </p>
                  </div>
                )}
